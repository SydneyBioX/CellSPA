...
```{r}
data_dir = "data/BIDCell_csv_output/"
tiff_path = "data/epoch_1_step_4000_connected_v3.tif"
...
```{r}
sce_ref_full <- readRDS("data/sce_FFPE_full.rds")
...
```{r}
spe_10x <- readXenium("data/10x_output/",
                      tiff_path = "data/10x_output/10x_from_csv.tif")
```
